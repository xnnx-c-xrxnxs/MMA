/**
 * @old-st/design-tokens — public barrel.
 *
 * Web consumers: import `tokens.css` via the subpath export
 *   `@old-st/design-tokens/tokens.css` (or its resolved path) in globals.css.
 ...
 *   import { lightColors, darkColors, spacing } from '@old-st/design-tokens';
 */
export {
  lightColors,
  darkColors,
