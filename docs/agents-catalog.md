...
| [ui-primitive-builder](./ui-primitive-builder.md)     | scoped-write (`packages/ui/`)                                                 | Builds NEW `@old-st/ui` primitives from a classification spec. Spawned by `/migrate-build-ui`.                                                                                                     |
