...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@old-st/contracts/user$': '<rootDir>/../../packages/contracts/user/src/index.ts',
    '^@old-st/contracts/order$': '<rootDir>/../../packages/contracts/order/src/index.ts',
    '^@old-st/contracts/product$': '<rootDir>/../../packages/contracts/product/src/index.ts',
