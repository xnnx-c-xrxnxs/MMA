...
const navItems = [
  ...
  // Add domain nav links here, e.g.
  // { href: '/widgets', label: 'Widgets', icon: '🔧' },
  // See examples/apps/webapp/src/components/layout/sidebar.tsx for the full
  // reference implementation (users, products, categories, orders).
];
